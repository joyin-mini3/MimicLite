...
class MotionDataset:
    ...
    def create_from_path(
        ...
        if robot_cfg.strict_joint_contract and source_joint_names != canonical_joint_names:
            raise ValueError(
                f"Robot '{robot_cfg.name}' strict motion joint contract mismatch; "
                f"expected={canonical_joint_names}, actual={source_joint_names}"
            )
